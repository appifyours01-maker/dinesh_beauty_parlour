...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/dinesh_beauty_parlour_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '699ec9b62e762d6e57b28cda',
      shopName: 'Dinesh beauty parlour',
...
app.listen(PORT, () => {
  console.log(`Dinesh beauty parlour Backend Server running on port ${PORT}`);
});
module.exports = app;
